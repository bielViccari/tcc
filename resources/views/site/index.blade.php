  ...
  letter-spacing: -.05rem;
    ...
    <div class="row featurette ml-3 mt-12">
      <div class="col-md-7">
        ...
        <p class="lead mt-4">a <a class="text-blue-500" href="https://www.techo.org/brasil/doar/">TETO</a> é uma organização da sociedade civil, sem fins lucrativos, que funciona graças à contribuição econômica das empresas, à cooperação internacional e a doações de pessoas como você.</p>
      </div>
      <div class="col-md-5">
    ...
    <div class="row featurette mt-3">
      <div class="col-md-7 order-md-2">
        ...
        <p class="lead mt-4">O <a class="text-green-600 link-success" href="https://doe.greenpeace.org.br"> Greenpeace</a> é uma organização internacional sem fins lucrativos e totalmente financiada por seus apoiadores. Não aceitam dinheiro de empresas e governos com o objetivo de manter a independência de sua atuação.</p>
      </div>
