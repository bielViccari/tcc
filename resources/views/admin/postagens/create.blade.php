...
#tel,#type,#qtd,#city,#bairro2,#rua2,#foto
{
...
@csrf
          ...
          <div class=" overflow-hidden sm:rounded-md">
            <div class="px-4 py-5  sm:p-6">
              <div id="fonte" class="grid grid-cols-6 gap-6">
                <div class="col-span-6">
                  <label id="oq_vai_doar" for="o_que_vai_doar" class="block text-sm font-medium text-gray-700">O que vai doar ?</label>
                ...
                <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                  <label id="tel" for="telefone" class="block text-sm font-medium text-gray-700">Telefone para contato:</label>
                ...
                <select id="country" name="tipo" autocomplete="tipo" class="mt-1 text-muted block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                  <option class="text-muted">calçado</option>
          ...
          <div class="col-span-6 sm:col-span-6 lg:col-span-2">
            <label id="city" for="cidade" class="block text-sm font-medium text-gray-700">Cidade</label>
          ...
          <div class="col-span-6 sm:col-span-3 lg:col-span-2">
            <label id="bairro2" for="bairro" class="block text-sm font-medium text-gray-700">Bairro</label>
          ...
          <div class="col-span-6 sm:col-span-3 lg:col-span-2">
            <label id="rua2" for="rua" class="block text-sm font-medium text-gray-700">Rua</label>
        ...
        <div>
          <label id="foto" class="block text-sm font-medium text-gray-700">
            Foto da doação
          </label>
